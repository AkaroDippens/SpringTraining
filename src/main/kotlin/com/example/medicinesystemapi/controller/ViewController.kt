...
class ViewController @Autowired constructor(
    ...
    fun getProfile(@RequestHeader(value = "Authorization") token: String?): ResponseEntity<ProfileResponse> {
        ...
        val medicalRecord = medicalRecordService.findMedicalRecordByUserId(user.id?.toLong())
            ?: return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null)
    ...
    private fun validateToken(token: String): String {
        val claims = Jwts.parserBuilder()
            .setSigningKey("cb7f3bb50c74c595bf95eaab227b9101ecb38f99adb19f31360c374a958a18a466fa192c0b409771b00c1bb4e0b6fb57ee1541ff25ceca686b1d4161f0c4d92a".toByteArray())
            .build()
