...
import com.example.medicinesystemapi.service.JwtTokenService
...
class AuthController @Autowired constructor(
    ...
    val SECRET_KEY: SecretKey = Keys.hmacShaKeyFor("cb7f3bb50c74c595bf95eaab227b9101ecb38f99adb19f31360c374a958a18a466fa192c0b409771b00c1bb4e0b6fb57ee1541ff25ceca686b1d4161f0c4d92a".toByteArray())
    ...
    private fun generateToken(mhiPolicy: String, userId: Long?, fullName: String?): String {
        val now = Date()
